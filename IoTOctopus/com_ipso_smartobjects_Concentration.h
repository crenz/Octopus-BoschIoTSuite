...
#ifndef __COM_IPSO_SMARTOBJECTS_CONCENTRATION_H__
#define __COM_IPSO_SMARTOBJECTS_CONCENTRATION_H__

#include <WString.h>

class com_ipso_smartobjects_Concentration
{
            public:
                com_ipso_smartobjects_Concentration();
        ...
        #endif // __COM_IPSO_SMARTOBJECTS_CONCENTRATION_H__
